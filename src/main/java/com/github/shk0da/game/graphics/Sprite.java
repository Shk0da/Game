package com.github.shk0da.game.graphics;
...
public class Sprite {
    ...
    public static void drawArray(Graphics2D g, Font f, String word, Vector2f pos, int size, int xOffset, int yOffset) {
        drawArray(g, f, word, pos, size, size, xOffset, yOffset);
    }
